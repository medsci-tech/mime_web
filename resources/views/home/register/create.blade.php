        ...
        <div class="medium-6 medium-centered large-4 large-centered columns">
            ...
            <form method="post" action="/home/register/store">
                ...
                <div class="row column log-in-form">
                    ...
                    @if($errors->has('phone'))
                        <p id="error_phone" class="help-text">{{ $errors->first('phone')}}</p>
                    @endif
                    <label>验证码
                    ...
                    @if($errors->has('auth_code'))
                        <p id="error_sms" class="help-text">{{ $errors->first('auth_code')}}</p>
                    @endif
                    <label>密码
                        <input v-model="password" type="password" placeholder="请输入密码" name="password">
                    </label>
                    <label>确认密码
                        <input v-model="password2" type="password" placeholder="请再次输入密码" name="password2">
                    </label>

                    @if($errors->has('password'))
                        <p id="error_passord" class="help-text">{{ $errors->first('password')}}</p>
                    @endif
