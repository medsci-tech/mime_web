            ...
            <div class="weui-cells weui-cells_form">
                <div class="weui-cell">
                    ...
                    <div class="weui-cell__bd">
                        <input class="weui-input" type="text" id="name" name="name" required placeholder="请输入用户名"/>
                    </div>
                </div>
                <div class="weui-cell">
                    <div class="weui-cell__hd"><label class="weui-label">手机号</label></div>
                    <div class="weui-cell__bd">
                        <input class="weui-input" type="tel" id="phone" name="phone" required placeholder="请输入手机号"/>
                    </div>
                </div>
                <div class="weui-cell weui-cell_vcode">
                    ...
                    <div class="weui-cell__bd">
                        <input class="weui-input" type="tel" id="code" name="code" required
                               placeholder="请输入验证码"/>
                    </div>
                    <div class="weui-cell__ft">
                        <span class="weui-vcode-btn" id="btnDetCodeOfRegister" style="cursor: pointer;">获取验证码</span>
                    </div>
                </div>
                ...
                <div class="weui-cell">
                    ...
                    <div class="weui-cell__bd dropdown">
                        <input class="weui-input" data-toggle="dropdown" type="text" id="hospital" name="hospital_name" value="请输入医院"/>
                ...
                <div class="weui-cell">
                    ...
                    <div class="weui-cell__bd">
                        <input class="weui-input" type="email" id="email" name="email" required placeholder="请输入邮箱"/>
                    </div>
                </div>
                <div class="weui-cell">
                ...
                <div class="weui-footer weui-footer_fixed-bottom">
                    <span type="submit" class="weui-btn weui-btn_primary" id="btnSignup" style="cursor: pointer;">点击报名</span></div>
            </div>
        </form></div></div>
</body>
...
<script type="text/javascript">
    $(function () {
        ...
        $('#btnSignup').on('click',function() {
            //$('.tips').hide();
            if(vali_req(code_dom) && vali_req(name_dom) && vali_req(hospital_dom) && vali_req(office_dom) && vali_req(title_dom) && vali_req(email_dom)){
