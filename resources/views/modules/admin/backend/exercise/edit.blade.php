  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" role="form" action="{{url('/exercise')}}?site_id={{$_GET['site_id'] ?? ''}}" method="post">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select class="form-control" name="check_type" id="form-check_type">
                @foreach(\Modules\Admin\Entities\Exercise::EXERCISE_CHECK_TYPE as $key => $val)
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select class="form-control" name="type" id="form-type">
                @foreach(\Modules\Admin\Entities\Exercise::EXERCISE_TYPE as $key => $val)
                  <option value="{{$key}}">{{$val}}</option>
                @endforeach
              </select>
            </div>
