...
<div class="page js_show home" style="margin-bottom:50px">
    <div class="page__hd header" style="padding: 0px;">
    	...
    	<div class="weui-media-box weui-media-box_appmsg" style="padding-top: 10px;padding-left: 30px;" onclick="location.href='<?php  if(!empty($islogin)) { ?><?php  echo create_url('mobile',array('act' => 'shopwap','do' => 'info'))?><?php }else{ ?><?php  echo create_url('mobile',array('act' => 'shopwap','do' => 'register'))?><?php  } ?>'" >
                    ...
                    <div class="weui-media-box__bd">
                        <h4 class="weui-media-box__title"><?php  if(!empty($islogin)) { ?><?php if(!empty($memberinfo['nickname'])){echo $memberinfo['nickname'];}else{echo $memberinfo['mobile'];};?><?php  }else{ ?>登录<?php  } ?></h4>
                        <p class="weui-media-box__desc" <?php  if(!empty($set_shop['levelurl'])) { ?>style="cursor: pointer;" onclick='location.href="<?php  echo $set_shop['levelurl'];?>"'<?php  } ?>>用户：<?php if($islogin){?><?php echo $memberinfo['realname']?> <?php  if(!empty($set_shop['levelurl'])) { ?><i class='fa fa-question-circle' ></i><?php  } ?><?php  }else{ ?>游客<?php  } ?></p>
...
<!--            </a>-->
                ...
                <div class="weui-cell__bd">
                    <p><div style="float:left;width:25px"><i class="fa fa-user" style="color:#A6E1EC;"></i></div>用户登录</p>
                </div>
                <div class="weui-cell__ft">
                </div>
            </a>
