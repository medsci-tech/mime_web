                    ...
                    <div class="col-sm-9 col-xs-12">
                        <div class="form-control-static"><table cellspacing="0" cellpadding="0">
							<tr>
								...
								<td  style='border:none;text-align:right;;'>迈豆<?php  echo number_format( $item['goodsprice'] ,2)?></td>
							</tr>
							<tr>
						...
						<tr>
								...
								<td  style='border:none;text-align:right;color:green;'>迈豆<?php  echo number_format($item['price'],2)?></td>
							</tr>
            ...
            <div class="panel-body table-responsive">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td>迈豆:<?php  echo $goods['marketprice'];?><br/></td>
