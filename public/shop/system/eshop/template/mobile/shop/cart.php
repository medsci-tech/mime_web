...
<div class="cart_top">
    ...
    <div class="cart_main">
        ...
        <%/each%>
        <div class="cart_count">共 <span class='total'><%total%></span> 件商品 合计: 迈豆<span class='totalprice'><%totalprice%></span></div>
    </div>
    <div class="cart_pay" style="<?php if(is_mobile()==false){?>max-width: 750px;<?php }?>">
        ...
        <div class="text">合计：<span>迈豆<span  class='totalprice'><%totalprice%></span></span><br><span style="color:#999; font-size:14px;">不含运费</span></div>
    </div>
</script>
