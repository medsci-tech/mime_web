...
<script id='goods_info'  type='text/html'>
    ...
    <div class="good_choose">
        <div class="info">
             ...
             <div class="right">
                   <div class="price">迈豆<span id='option_price'><%goods.marketprice%></span></div>
...
<!--                   <div class="option">请选择规格</div>-->
    ...
    <div class="good_info1">
        ...
        <%/if%>
        <div class="price">迈豆<d id='marketprice'>
                <%if goods.minprice !=goods.maxprice%>
                <%goods.minprice%> - <%goods.maxprice%>
                <%else%>
                <%goods.marketprice%>
                <%/if%>
            </d>&nbsp;<span id='productpricecontainer'><%if goods.productprice>0%><%/if%><span id='productprice'><%if goods.productprice>0%><%/if%></span></span>
...
<script id='tpl_recommand' type='text/html'>
    ...
    <div class="good" data-goodsid='<%g.id%>'>
        ...
        <div class="price">迈豆<%g.marketprice%> <%if g.productprice>0 && g.marketprice!=g.productprice%><span></span><%/if%></div>
    </div>
    <%/each%>
</script>
