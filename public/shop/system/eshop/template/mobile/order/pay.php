...
<script id='tpl_order_info' type='text/html'>
    ...
    <div class="order_main" >  
        ...
        <div class="line"><div class="label">支付金额</div><div class="info"><div class="inner"><div style='color:#ff6600'>迈豆<span id="orderprice" price="<%order.price%>"><%order.price%></span></div></div></div></div>
    </div>
    <%if order.price>0%>    

    
    <%if credit.success %>
        <div class="button order_sub3">迈豆余额支付(当前迈豆:<%credit.current%>)</div>
