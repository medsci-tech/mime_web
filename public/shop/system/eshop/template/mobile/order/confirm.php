...
<script id='tpl_confirm_info' type='text/html'>
 <div class="page_topbar" >
    ...
    <div class="addorder_good">
        ...
        <div class="text">共 <span id="goodscount"><%total%></span> 件商品 合计：<span style="color:#ff771b;">迈豆<span class='goodsprice' style="color:#ff771b;"><%goodsprice%></span></span></div>
    </div>
    <div class="addorder_price" >
        <input type="hidden" id="weight" value="<%weight%>" />
        <div class="price" style="border:none;">
            <div class="line" style="line-height:26px;">商品金额<span>迈豆<span class='goodsprice'><%goodsprice%></span></span></div>
           
            <div class="line" style="line-height:26px;display: none">+运费<span>￥<span class='dispatchprice'><%dispatchprice%></span></span></div>
            <%if discountprice>0%>
    ...
    <div class="addorder_pay">
        ...
        <input type="hidden"  id="credit" value="<%member.credit1%>" />
        <span>需付：迈豆<t class='totalprice' id="totalprice"><%realprice%></t></span>
    </div> 
</script>
<?php  if($hascoupon_p) { ?>
