var city_data = {
  ...
  "河北": {
    "石家庄": ["长安区", "桥东区", "桥西区", "新华区", "郊区", "井陉矿区", "井陉县", "正定县", "栾城县", "行唐县", "灵寿县", "高邑县", "深泽县", "赞皇县", "无极县", "平山县", "元氏县", "赵县", "辛集市", "藁", "晋州市", "新乐市", "鹿泉市"],
    "唐山": ["路南区", "路北区", "古冶区", "开平区", "新区", "丰润县", "滦县", "滦南县", "乐亭县", "迁西县", "玉田县", "唐海县", "遵化市", "丰南市", "迁安市"],
    ...
    "保定": ["新市区", "北市区", "南市区", "满城县", "清苑县", "涞水县", "阜平县", "徐水县", "定兴县", "唐县", "高阳县", "容城县", "涞源县", "望都县", "安新县", "易县", "曲阳县", "蠡县", "顺平县", "博野", "雄县", "涿州市", "定州市", "安国市", "高碑店市"],
  ...
  "山西": {
    ...
    "晋中": ["榆次市", "介休市", "榆社县", "左权县", "和顺县", "昔阳县", "寿阳县", "太谷县", "祁县", "平遥县", "灵石县"],
    "临汾": ["临汾市", "侯马市", "霍州市", "曲沃县", "翼城县", "襄汾县", "洪洞县", "古县", "安泽县", "浮山县", "吉县", "乡宁县", "蒲县", "大宁县", "永和县", "隰县", "汾西县"],
    "运城": ["运城市", "永济市", "河津市", "芮城县", "临猗县", "万荣县", "新绛县", "稷山县", "闻喜县", "夏县", "绛县", "平陆县", "垣曲县"]
  },
  "内蒙古": {
    "呼和浩特": ["新城区", "回民区", "玉泉区", "郊区", "土默特左旗", "托克托县", "和林格尔县", "清水河县", "武川县"],
    "包头": ["东河区", "昆都伦区", "青山区", "石拐矿区", "白云矿区", "郊区", "土默特右旗", "固阳县", "达尔罕茂明安联合旗"],
    "乌海": ["海勃湾区", "海南区", "乌达区"],
  ...
  "上海": {"上海": ["黄浦区", "卢湾区", "徐汇区", "长宁区", "静安区", "普陀区", "闸北区", "虹口区", "杨浦区", "宝山区", "闵行区", "嘉定区", "松江区", "金山区", "青浦区", "南汇区", "奉贤区", "浦东新区", "崇明县", "其他"]},
  "江苏": {
...
function city_selector(user_config) {
  ...
  //初始化
  province_container.html('').append('<option value="" > 选择省 </option>');
  city_container.html('').append('<option value="" > 选择市 </option>');
  area_container.html('').append('<option value="" > 选择区 </option>');
  ...
  $(config.province).on('change', function () {
    ...
    var cities = city_data[cur_province];

    city_container.html('');
    city_container.append('<option value="" > 选择市 </option>');
    area_container.html('');
    area_container.append('<option value="" > 选择区 </option>');
  ...
  $(config.city).on('change', function () {
    ...
    var areas = city_data[cur_province][cur_city];
  ...
  // 默认选中
  if (old_province = province_container.attr('data-old')) {
    province_container.val(old_province).change();
  }
  ;
  if (old_city = city_container.attr('data-old')) {
    city_container.val(old_city).change();
  }
  ;
  if (old_area = area_container.attr('data-old')) {
    area_container.val(old_area).change();
  }
  ;
}